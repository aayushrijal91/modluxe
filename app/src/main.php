                ...
                <div class="row pt-5 gy-7 gx-md-2 gx-lg-4">
                    ...
                    <div class="col-md-6">
                        <div class="team-card">
                            ...
                            <div class="fs-14 fw-300 font-inter pt-3">
                                <p>Raymond Albassit is the Co-founder and managing director of Modluxe. Ray has over 25 years experience in the Gyprock/Plastering, remedial building repairs, bathrooms, renovation and construction industry. His experience is vast and shows through the pride that he takes in his work. Workmanship and client experience is how Ray has developed a first class reputation.</p>
                                <p>Ray is passionate about his work and providing outstanding customer service. Ray is the founder and director of Complete Interior Linings, the professionals in Gyprocking & Plastering. CIL is one of the most renowned names in commercial fit outs, renovations and plaster works. Having relationships with all the major builders and insurance companies across Australia. His large team ensures quality workmanship is delivered everytime.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row pt-5">
                    ...
                    <div class="col col-md-6">
                        <div class="row justify-content-between justify-content-lg-end align-items-center gy-lg-4">
                            ...
                            <div class="col col-md-auto">
                                <a href="https://www.kcconstructionsnsw.com.au/" target="_blank"><?= renderImg('kc-constructions.png', 'lib') ?></a>
                            </div>
                            <div class="col col-md-auto">
                                <a href="https://www.completeinteriorlinings.com.au/" target="_blank"><?= renderImg('cil.png', 'lib') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
